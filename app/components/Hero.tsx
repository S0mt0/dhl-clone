...
const Hero = () => {
  return (
    <div className={_.App__hero}>
      <div className={_.img__container}>
        <picture>
          <img
            src="/employee-receives-customer-signature-0001.jpg"
            alt="hero_image"
          />
        </picture>
        <div className={_.App__hero_overlay}>
            ...
            <div className={_.hero_quicklinks}>
              ...
              <div>
                ...
                <div className={_.quicklink_text}>
                  ...
                  <p>
                    Shipping regulaly? Request a business account and profit
